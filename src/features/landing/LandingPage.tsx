    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
            <a href="#features" className="hover:text-emerald-600 transition-colors">ফিচারসমূহ</a>
            <a href="#about" className="hover:text-emerald-600 transition-colors">আমাদের সম্পর্কে</a>
            <a href="#pricing" className="hover:text-emerald-600 transition-colors">প্রাইসিং</a>
          </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="relative mx-auto max-w-5xl rounded-3xl border border-slate-200 bg-white p-2 shadow-2xl shadow-slate-200/50 overflow-hidden">
              <img 
            ...
            <div className="absolute -top-6 -left-6 hidden lg:block">
              <div className="bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-medium">সক্রিয় শিক্ষার্থী</p>
                  <p className="text-lg font-bold text-slate-900">১২,৫০০+</p>
                </div>
              </div>
            </div>
            <div className="absolute -bottom-6 -right-6 hidden lg:block">
              <div className="bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-slate-500 font-medium">এআই প্রশ্ন তৈরি</p>
                  <p className="text-lg font-bold text-slate-900">৫০,০০০+</p>
                </div>
              </div>
            </div>
          </motion.div>
